...
bool CInputStreamAdaptive::Open(INPUTSTREAM& props)
{
  ...
  for (unsigned int i(0); i < props.m_nCountInfoValues; ++i)
  {
    ...
    {
      kodi::Log(ADDON_LOG_DEBUG, "found inputstream.adaptive.license_key: [not shown] : %s", props.m_ListItemProperties[i].m_strValue);
    ...
    {
      kodi::Log(ADDON_LOG_DEBUG, "found inputstream.adaptive.license_data: [not shown] : %s", props.m_ListItemProperties[i].m_strValue);
    ...
    {
      kodi::Log(ADDON_LOG_DEBUG, "found inputstream.adaptive.server_certificate: [not shown] : %s",props.m_ListItemProperties[i].m_strValue);
